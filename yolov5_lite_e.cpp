...
#else
    yolov5.load_param("../weight/v5lite-e.param");//参数的位置是相对于launch.json
    yolov5.load_model("../weight/v5lite-e.bin");
#endif
...
static void draw_objects(const cv::Mat& bgr, const std::vector<Object>& objects,const char* savepath)
{
...
int main(int argc, char** argv)
{
    ...
    draw_objects(m, objects,savepath);
